...
path = r"C:\Users\Administrator\Downloads\NGGit\app\src\main\java\io\nggit\ui\main\MainActivity.kt"

code = '''package io.nggit.ui.main
...
print(f"Written {len(code)} chars to {path}")
